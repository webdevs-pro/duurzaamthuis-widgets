                     ...
                     echo '<div class="dh-product-wrapper">';
                        echo '<div class="dh-product-column">';
                           ...
                           echo '<div class="dh-product-score">';
                              ...
                              // echo '<img src="' . $settings['dh_product_comparition_sustainability_score_logo_url'] . '" alt="">';
                        ...
                        if ( $item['dh_product_comparition_sustainability_score_custom_type'] == 'ean' ) {
                        ...
                        if ( $item['dh_product_comparition_sustainability_score_custom_type'] == 'shortcode' ) {
                           echo '<div class="dh-product-column dh-product-shortcode-column">';
                              echo '<div class="dh-product-shortcode-heading">Beste prijs</div>';
                        ...
                        if ( $item['dh_product_comparition_sustainability_score_custom_type'] == 'button' ) {
                           echo '<div class="dh-product-column dh-product-button-column type-button">';
                              if ( $item['dh_product_comparition_sustainability_score_button_image']['id'] ) {
                                          ...
                                          echo '<a target="_blank" href="' . $item['dh_product_comparition_sustainability_score_button_link'] . '"' . $rel . '>';
                                             echo '<div class="item">';
                                                echo '<div class="dfrcs_logo">';
                                                   echo wp_get_attachment_image( $item['dh_product_comparition_sustainability_score_button_image']['id'], 'medium' );
                                                echo '</div>';
                        ...
                        <div class="dh-product-wrapper">
                           ...
                           <# if ( item.dh_product_comparition_sustainability_score_custom_type == 'button' ) { #>
                              <div class="dh-product-column dh-product-button-column">
                                 <# if ( item.dh_product_comparition_sustainability_score_button_image.url ) { #>
                                    <div class="dfrcs">
                                 ...
                                 <# } else { #>
                                    <span class="elementor-button elementor-size-sm no-logo">{{ item.dh_product_comparition_sustainability_score_button_text }}</span>
                                 <# } #>
                              </div>
                           <# } #>
                        </div>
