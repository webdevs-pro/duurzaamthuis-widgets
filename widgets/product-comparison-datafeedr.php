...
class DH_Product_Comparison_Datafeedr extends \Elementor\Widget_Base {

	public function get_name() {
		return 'dh-product-comparition-datafeedr';
	}

	public function get_title() {
		return __( 'Product Comparison Datafeedr', 'duurzaamthuis' );
	}
